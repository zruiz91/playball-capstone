PlayBall allows users to create an account and get access to a list of Houston area parks with their corresponding addresses and a alist of sports that can be played at that park.
